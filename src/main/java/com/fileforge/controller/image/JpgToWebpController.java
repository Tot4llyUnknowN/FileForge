...
public class JpgToWebpController {
    ...
    private void chooseFile() {
        ...
        chooser.setTitle("Select JPG Image");
    ...
    private void convert() {
        if (selectedFile == null) {
            statusLabel.setText("Please select a JPG file first.");
            return;
        }

        FileChooser saveChooser = new FileChooser();
        saveChooser.setTitle("Save WEBP");
        String baseName = selectedFile.getName().replaceFirst("\\.(jpg|jpeg)$", "");
        saveChooser.setInitialFileName(baseName + ".webp");
        ...
        try {
            ImageConversionUtil.convert(selectedFile, outputFile, "webp");
